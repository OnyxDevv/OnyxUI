	...
	function Window:CreateTab(TabSettings)
		...
		function Tab:CreateSection(name : string)
			...
			function Section:CreateSlider(SliderSettings, Flag)
				...
				Slider.Interact.MouseButton1Down:Connect(function()
					...
					local Loop; Loop = RunService.Stepped:Connect(function()
						if SLDragging then
							Location = math.clamp(UserInputService:GetMouseLocation().X, Slider.Main.AbsolutePosition.X, Slider.Main.AbsolutePosition.X + Slider.Main.AbsoluteSize.X)
			...
			function Section:CreateInput(InputSettings, Flag)
                ...
                Input.InputFrame.InputBox.Active = true
                Input.InputFrame.InputBox.Interactable = true
